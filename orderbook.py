...
class OrderbookWidget(QWidget):
    def __init__(self,parent=None,ticker="BTC"):
        ...
        for i in range(self.tableBids.rowCount()):
            ...
            item_2.setStyleSheet("""QProgressBar {background-color : rgba(0, 0, 0, 0%);border : 1} QProgressBar::Chunk {background-color : rgba(255, 0, 0, 50%);border : 1}""")
            ...
            item_2.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
            item_2.setStyleSheet(""" QProgressBar {background-color : rgba(0, 0, 0, 0%);border : 1} QProgressBar::Chunk {background-color : rgba(0, 255, 0, 40%);border : 1}""")
